...
# spaceflights_delta documentation build
...
from spaceflights_delta import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_delta"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_deltadoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_delta.tex",
        "spaceflights_delta Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_delta",
        "Project spaceflights_delta codebase.",
        "Data-Science",
    )
]
