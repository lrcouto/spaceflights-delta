...
from spaceflights_delta.pipelines.data_science import create_pipeline as create_ds_pipeline
from spaceflights_delta.pipelines.data_science.nodes import split_data
